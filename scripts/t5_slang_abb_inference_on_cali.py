"""
T5 Slang+Abbreviation Model Inference on California Plates
==========================================================
Apply a T5 model trained on combined slang and abbreviations
to interpret California vanity plates.
...
MODEL_TIMESTAMP = "20241130_141308"
...
def main():
    ...
    print("=" * 60)
    print("T5 Slang+Abbreviation Model Inference on California Plates")
    print("=" * 60)
    
    # Define paths
    model_path = MODEL_CHECKPOINTS_DIR / f"best_t5_ft_slang_abb_model_{MODEL_TIMESTAMP}"
    input_csv = DATA_DIR / "cali.csv"
    
    timestamp = get_timestamp()
    output_csv = OUTPUTS_DIR / f"t5_ft_slang_abb_predictions_on_cali_{timestamp}.csv"
